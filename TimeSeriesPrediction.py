...
def main():
    ...
    default_params = {
        'file_path': os.path.join(root_address, 'dataset', 'cimen_mshd.csv'),
        'window_size': 720,
        ...
        'loss_function': 'mse',
        'retrain': True,
        'model_path': "./results/run_20241217_110743/best_model_full_data.keras",
        'params_path': "./results/run_20241217_110743/Model_params.pkl",
